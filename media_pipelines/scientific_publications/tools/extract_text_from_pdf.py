...
class PDFTextExtractor:
    ...
    def _load_extraction_prompt(self) -> str:
        ...
        prompt = """
You are an expert at extracting text content from scientific documents. Your task is to extract ALL the text content from the provided document, maintaining the original structure and formatting as much as possible.

IMPORTANT GUIDELINES:
1. Extract EVERY piece of text you can see - titles, headings, body text, captions, footnotes, etc.
2. Preserve the logical structure and hierarchy
3. Maintain line breaks and paragraph breaks where they make sense
4. Include any mathematical expressions or formulas as text
5. Preserve section headers and subheaders
6. Include any text in tables, figures, or appendices
7. Do not summarize or paraphrase - extract the exact text
8. If you encounter any text that's unclear or corrupted, include it as-is
